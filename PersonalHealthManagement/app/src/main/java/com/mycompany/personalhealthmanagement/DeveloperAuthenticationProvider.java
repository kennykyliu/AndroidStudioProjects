...
import devauth.client.AmazonCognitoSampleDeveloperAuthenticationClient;
import devauth.client.GetTokenResponse;
...
public class DeveloperAuthenticationProvider extends
    ...
    private static final String developerProvider = "mycompany.personalhealthmanagement";
    private static final String cognitoSampleDeveloperAuthenticationAppEndpoint = "http://54.175.245.228";
