            ...
            try {
                if (mExtension == null) {
                    mUpload = getTransferManager().upload(
                            Constants.PHOTO_MANAGER_BUCKET_NAME.toLowerCase(Locale.US),
                            Constants.currUserName + "/" + Constants.currAlbumName + "/" + super.getFileName(), mFile);
                    Log.i(TAG, "Upload to file: " +
                            Constants.currUserName + "/" + Constants.currAlbumName + "/" + super.getFileName());
                } else {
                    mUpload = getTransferManager().upload(
                            Constants.PHOTO_MANAGER_BUCKET_NAME.toLowerCase(Locale.US),
                            Constants.currUserName + "/" + Constants.currAlbumName + "/" + super.getFileName() + "."
