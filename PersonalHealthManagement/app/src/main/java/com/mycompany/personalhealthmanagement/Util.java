...
public class Util {
    ...
    public static boolean doesBucketExist() {
        return sS3Client.doesBucketExist(Constants.PHOTO_MANAGER_BUCKET_NAME.toLowerCase(Locale.US));
    }

    public static void createBucket() {
        sS3Client.createBucket(Constants.PHOTO_MANAGER_BUCKET_NAME.toLowerCase(Locale.US));
    }

    public static void deleteBucket() {
        String name = Constants.PHOTO_MANAGER_BUCKET_NAME.toLowerCase(Locale.US);
